...
{ 
    ...
    box1.primitives[0].dimensions = { 0.05, 0.05, 0.05 }; 
    geometry_msgs::msg::Pose pose1; 
    pose1.position.x = 0.25; 
    pose1.position.y = -0.2; 
    pose1.position.z = 0.025; // Half of the height for proper placement
    ...
    box2.primitives[0].dimensions = { 0.05, 0.05, 0.05 }; 
    ...
    box3.primitives[0].dimensions = { 0.05, 0.05, 0.05 }; 
    geometry_msgs::msg::Pose pose3; 
    pose3.position.x = 0.25; 
    pose3.position.y = 0.1; 
    pose3.position.z = 0.025; 
    ...
    box4.primitives[0].dimensions = { 0.05, 0.05, 0.05 }; 
    geometry_msgs::msg::Pose pose4; 
    pose4.position.x = 0.25; 
    pose4.position.y = -0.35; 
    pose4.position.z = 0.025; 
    ...
    wall.primitives[0].dimensions = { 0.1, 3.0, 2.0 }; 
    geometry_msgs::msg::Pose wall_pose; 
    wall_pose.position.x = 0.1; 
    wall_pose.position.y = 0.0; // Centered on the y-axis
    wall_pose.position.z = 1.0; // Half of the height for proper placement
    wall_pose.orientation.w = 1.0; 
    wall.pose = wall_pose; 

    // Apply all objects to the planning scene
    moveit::planning_interface::PlanningSceneInterface psi; 
    std::vector<moveit_msgs::msg::CollisionObject> objects = { box1, box2, box3, wall }; 
...
int main(int argc, char** argv)
{
  ...
  mtc_task_node->doTask("Task 1","box1", 0.25, 0.0);
  mtc_task_node->doTask("Task 2","box2", 0.25, 0.0);
  mtc_task_node->doTask("Task 3","box3", 0.25, 0.0);
  mtc_task_node->doTask("Task 4","box4", 0.25, 0.0);
